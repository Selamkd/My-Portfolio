const Header = () => {
  return (
    <header class="top-0 sm:top-4 rounded-none sm:rounded-full border-b sm:border bg-[#0000] dark:bg-blackish/30 border-gray-800/50 dark:border-gray-400/10 p-3 z-50 backdrop-blur-md w-full m-auto max-w-3xl flex justify-between items-center sticky">
      <nav class="w-full flex justify-between items-center">
        <button
          data-state="closed"
          type="button"
          class="circle-button plausible-event-name=Logo+Visit"
        >
          {/* <p class="font-bold text-center text-white  text-code text-draplin transition-all">
            SA
          </p> */}
        </button>
